...
#print("Usage: <channel> <topic> <output> <offset>")
def queryapi(_channel, _topic, _outfile, _offset): 
	url = "https://holodex.net/api/v2/videos"
	
	querystring = {"channel_id":_channel,"topic":_topic,"type":"stream","limit":"25","offset":_offset}
#	querystring = {"channel_id":_channel,"topic":_topic,"limit":2}
